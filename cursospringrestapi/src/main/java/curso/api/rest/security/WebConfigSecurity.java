...
/**
 * Classe para implementar segurança : Mapeia URL, endereçõs, autoriza ou
 * bloqueia acesso a URL.
 * 
 * @author Expedito ALmeida
 */
...
public class WebConfigSecurity extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse())
				...
				/*
				 * Filtra demais requisições para verificar a presenção do token JWT no header
				 * HTTP
				 */
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		// Service que irá consultar o usuário na base de dados
